...
% 本模板在github上的武大毕业论文模板（https://github.com/whutug/whu-thesis，在此，向作者WHU TeX User Group致谢）的基础上做了大量的修改，以符合最新的物院毕业论文模板要求（几乎全部），如果后续物院模板更新，则可根据最新模板在cls里做相应的修改。
% --- Author：Zhengxin Tang
% 补充：由于时间有限，只修改了硕士的模板！！！！！！！！！！！！
% 后续会修改博士模板
